...
<body>
  ...
  <main>
    ...
    <div class="container">
      <div class="row">
        <form class="col-sm-6" method="post" action="..\controllers\LoginController.php">
          <div id="col-sm-12 ">
            <img id="regis-img" src="..\..\css\registration-img.png" alt="pen">
          </div>
          <div id="col-sm-12 ">
            <h2 class="landingText">Login</h2>
          </div>
          ...
          <button type="submit" class="btn btn-warning registerbtn">Login</button>
        </form>
